    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Register Masyarakat</h5>

              <!-- General Form Elements -->
              <form  action="<?= base_url('Home/aksi_t_masyarakat') ?>" method="POST">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Masyarakat</label>
                  <div class="col-sm-10">
