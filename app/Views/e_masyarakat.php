...
<div class="container">
  <form action="<?= base_url('Home/aksi_e_masyarakat') ?>" method="POST">
      ...
      <div class="mb-3 mt-3">
        <label for="nama" class="form-label">Nama Masyarakat</label>
        <input type="text" class="form-control" id="nama" placeholder="Enter Nama Barang"   name="nama" value="<?= $satu->nama_lengkap ?>">
      </div>
